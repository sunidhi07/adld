...
# Generated on: Thu Dec 02 17:04:45 IST 2021 (Thu Dec 02 11:34:45 GMT 2021)

set lec_version [regsub {(-).} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file fv/encoder/rtl_to_fv_map.log -replace
...
read_design   -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k encoder.v
...
#add_name_alias fv/encoder/fv_map.singlebit.original_name.alias.json.gz -revised
