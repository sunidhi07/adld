...
# Generated on: Thu Dec 02 16:39:54 IST 2021 (Thu Dec 02 11:09:54 GMT 2021)

set lec_version [regsub {(-).} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file fv/decoder/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/decoder -revised fv_map
...
read_design   -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k decoder.v
elaborate_design -golden -root {decoder} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/decoder/fv_map.v.gz
elaborate_design -revised -root {decoder}
