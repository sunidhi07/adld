...
# Generated on: Fri Dec 03 16:28:01 IST 2021 (Fri Dec 03 10:58:01 GMT 2021)

set lec_version [regsub {(-).} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file fv/jkff/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/jkff -revised fv_map

set_parallel_option -threads 4 -license "xl lp gxl lpgxl eco ecogxl" -norelease_license

set env(RC_VERSION)     "17.22-s017_1"
set env(CDN_SYNTH_ROOT) "/cad_area/install/GENUS172/tools.lnx86"
set CDN_SYNTH_ROOT      "/cad_area/install/GENUS172/tools.lnx86"
set env(CW_DIR) "/cad_area/install/GENUS172/tools.lnx86/lib/chipware"
set CW_DIR      "/cad_area/install/GENUS172/tools.lnx86/lib/chipware"

# default is to error out when module definitions are missing
set_undefined_cell black_box -noascend -both

add_search_path . /cad_area/install/GENUS172/tools.lnx86/lib/tech -library -both
read_library -liberty -both   /cad_area/cad/FOUNDRY/digital/180nm/dig/lib/slow.lib
...
read_design   -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k jkff.v
elaborate_design -golden -root {jkff} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/jkff/fv_map.v.gz
elaborate_design -revised -root {jkff}
...
#add_name_alias fv/jkff/fv_map.singlebit.original_name.alias.json.gz -revised
